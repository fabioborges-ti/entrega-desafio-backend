...
- [Testes](#-testes)
- [Resultados de Testes e Cobertura](./docs/tests.md)
...
![Diagrama de arquitetura Clean DDD CQRS WebApi](./images/arquitetura-clean-ddd-cqrs-webapi.png)
...
| [docs/tests.md](./docs/tests.md) | Evidências da última execução de testes e cobertura de código |
