...
public class UserValidatorTests
{
    ...
    /// <summary>
    /// Telefone vazio deve falhar (contrato API: string obrigatória).
    /// </summary>
    [Fact(DisplayName = "Empty phone should fail validation")]
    public void Given_EmptyPhone_When_Validated_Then_ShouldHaveError()
    {
        // Arrange
        var user = UserTestData.GenerateValidUser();
